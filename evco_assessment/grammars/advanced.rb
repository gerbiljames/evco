def advanced_grammar
  ...
  grammar = {
      ...
      "action(m_run)" => ["setAhead(<double(m_run)>)", "setBack(<double(m_run)>)", "setTurnRight(<double(m_run)>)", "setTurnLeft(<double(m_run)>)", "setTurnGunLeft(<double(m_run)>)", "setTurnGunRight(<double(m_run)>)", "setTurnRadarLeft(<double(m_run)>)", "setTurnRadarRight(<double(m_run)>)", "setFire(<double(m_run)>)"],
      "m_run" => ["<statements(m_run)>"],

      "int(m_on_hit_wall)" => ["<int(literal)>"],
      "double(m_on_hit_wall)" => ["e.getBearing()", "getVelocity()", "getHeading()", "<double(literal)>"],
      "boolean(m_on_hit_wall)" => ["<bexp(m_on_hit_wall)>"],
      ...
      "action(m_on_hit_wall)" => ["ahead(<double(m_on_hit_wall)>)", "back(<double(m_on_hit_wall)>)", "turnRight(<double(m_on_hit_wall)>)", "turnLeft(<double(m_on_hit_wall)>)"],
      "m_on_hit_wall" => ["<statements(m_on_hit_wall)>"],

      "int(m_on_hit_by_bullet)" => ["<int(literal)>"],
      ...
      "boolean(m_on_hit_by_bullet)" => ["<bexp(m_on_hit_by_bullet)>"],
      ...
      "int(m_on_bullet_hit)" => ["<int(literal)>"],
      ...
      "boolean(m_on_bullet_hit)" => ["<boolean(literal)>", "<bexp(m_on_bullet_hit)>"],
      ...
      "boolean(m_on_hit_robot)" => ["e.isMyFault()", "<bexp(m_on_hit_robot)>"],
      ...
      "action(m_on_hit_robot)" => ["ahead(<double(m_on_hit_robot)>)", "back(<double(m_on_hit_robot)>)", "turnRight(<double(m_on_hit_robot)>)", "turnLeft(<double(m_on_hit_robot)>)", "fire(<int(m_on_hit_robot)>)"],
